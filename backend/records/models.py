...
class Record(models.Model):
    ...
    pitar_naam = models.TextField("পিতার নাম")
    matar_naam = models.TextField("মাতার নাম")
    pesha = models.TextField("পেশা")
    occupation_details = models.TextField(blank=True, null=True)
    jonmo_tarikh = models.CharField("জন্ম তারিখ", max_length=100)
    thikana = models.TextField("ঠিকানা")
